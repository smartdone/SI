...
public class EncryptTools {
    ...
    private static EncryptMessage encryptmessage = new EncryptMessage();
    ...
    public static void encrypt(Handler handler, String srcpath, String destPath, String password) {
        try {
            ...
            IvParameterSpec iv = new IvParameterSpec("1234567890qwerty".getBytes());
